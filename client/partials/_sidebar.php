...
if (!$stmt) {
    // หาก prepare() ล้มเหลว ให้แสดงข้อความข้อผิดพลาดเพื่อดีบัก
    die("Prepare failed: " . $mysqli->error);
}
// ใช้การ bind_param เพื่อเพิ่มความปลอดภัย
...
while ($row = $res->fetch_object()) {
    // ดำเนินการตามที่คุณต้องการกับ $row
}
$stmt->close();
{
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="hrm.php">
              <i class="fas fa-user-tie text-success"></i> Human resource management
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="customes.php">
              <i class="fas fa-users text-success"></i> Booking
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="products.php">
              <i class="ni ni-bullet-list-67 text-success"></i> Products
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="orders.php">
              <i class="ni ni-cart text-success"></i> Orders
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="payments.php">
              <i class="ni ni-credit-card text-success"></i> Payments
            </a>
          </li>
          <li class="nav-item">
